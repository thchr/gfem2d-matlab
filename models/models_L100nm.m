...
clear models
models(1) =      struct('type','isotropic','ef_eV',ef_eV,'L',L,'B',0,'system',[]        ,'approx','intra','keep_eV',[0,2*ef_eV]);

magnetodefault = struct('type','magneto'  ,'ef_eV',ef_eV,'L',L,'B',2,'system','graphene','approx',[]     ,'keep_eV',[0,2*ef_eV]);
Blist = [2,4,8];
