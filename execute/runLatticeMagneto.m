function savepath = runLatticeMagneto(latticetype,kspec,Ns,Ncirc,adivd,Nk,savephi,models,addstr)
...
if nargin < 8 || ~exist('models','var') || isempty(models) %Standard, default model
    ...
    models(2) = struct('type','magneto'  ,'ef_eV',ef_eV,'L',L,'B',4 ,'system','graphene','approx',[]     ,'keep_eV',[0,ef_eV]); 
    models(3) = struct('type','magneto'  ,'ef_eV',ef_eV,'L',L,'B',8 ,'system','graphene','approx',[]     ,'keep_eV',[0,ef_eV]); 
