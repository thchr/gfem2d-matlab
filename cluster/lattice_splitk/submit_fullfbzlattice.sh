...
kxlist="linspace(0,4*pi/3,${numkx})";
kylist="(${ky}-1)/(${numky}-1)*2*pi/sqrt(3)";
savename="fullfbz_Ns${Ns}_${ky}of${numky}";
# here follow the commands you want to execute
matlab -nodisplay -nosplash -r "runLatticeMagneto('$lattype',{'${kxlist}','${kylist}'},$Ns,$Ncirc,[],[],[],[],'${savename}')"  -logfile "../output/logs/2d_fullfbz_${Ns}_${ky}of${numky}.tex"
